...
#get tables
file_names = list.files(path = "3_output",
                pattern = "table",
                full.names = T)

#add weeky input
file_names = c(week_filterly_input_format, file_names)
...
saveWorkbook(wb, "3_output/weekly_report_output.xlsx", overwrite = TRUE)
