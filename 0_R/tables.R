...
data_zone_wk = check_read_fun(fn_3_output)
...
write.csv(t1a, "3_output/table1a.csv", row.names = F)
write.csv(t2a, "3_output/table2a.csv", row.names = F)
write.csv(t3a, '3_output/table3a.csv', row.names = F)
