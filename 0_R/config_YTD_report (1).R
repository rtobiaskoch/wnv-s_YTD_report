...
fn_datasheet_clean = paste0(dir_mid,"/y",year_filter, "_", "w",week_filter, "_datasheet.csv")
fn_datasheet_clean_test = paste0(dir_mid,"/y",year_filter, "_", "w",week_filter, "_datasheet_test.csv")
week_filterly_input_format_mid = file.path(dir_mid, "weekly_data_input_format_mid.RData")
fn_cq_out = paste0(dir_mid,"/y",year_filter, "_", "w",week_filter, "_platemap.csv")
fn_abund_out = paste0(dir_mid,"/y",year_filter, "_", "w",week_filter, "_abundance")
fn_pools_mid = paste0(dir_mid,"/y",year_filter, "_", "w",week_filter, "_pools.csv")
...
fn_data_output = paste0(dir_output,"y",year_filter, "_", "w",week_filter, "_data_update.csv")
week_filterly_input_format = file.path(dir_output, "weekly_data_input_format.csv")
